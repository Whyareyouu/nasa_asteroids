...
export const DistanceLine: FC<DistanceLineProps> = memo(({distance}) => {
    ...
    return (
        <div className={styles.distanceLine}>
            <div className={styles.text} ref={textRef}>{distance} км</div>
            <svg xmlns="http://www.w3.org/2000/svg" height="6" viewBox="0 0 105 6" fill="none"
                 ref={svgRef}>
                <path
